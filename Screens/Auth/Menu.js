...
import { StyleSheet, TouchableOpacity, View, Image, FlatList, TextInput, SafeAreaView } from 'react-native';
...
const Menu = ({ navigation, route }) => {
    ...
    if(index>0)
    {
      ...
      indexAfter =Data[index+1].category;
    }
        ...
        <React.Fragment>
        <Text style={{ fontWeight: 'bold', fontSize: responsiveFontSize(2),marginLeft:responsiveWidth(-2) }} value={item.category} />
          <View style={{
            width: '120%',
            // paddingVertical: responsiveHeight(2),
            borderBottomColor: '#A6A6A6',
	...
	return (
		<SafeAreaView style={styles.parent}>
			...
			<View style={styles.HeadingContainer}>
				...
				<TextInput placeholder={'Search'} value={menuItem} onChangeText={onChangeSearch} style={styles.input} />
			</View>
			{isLoading ? (
				<Text
