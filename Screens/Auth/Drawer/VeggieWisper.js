...
const VeggieWisper = ({ navigation, route, ...props }) => {
	...
	const getFacebookVal = () => {
		if (TruckInfo.socialMedia.facebook.includes('facebook.com')) return TruckInfo.socialMedia.facebook;
		else return String('https://www.facebook.com/' + TruckInfo.socialMedia.facebook + '/');
	};
	const getInstaVal = () => {
		if (TruckInfo.socialMedia.instagram.includes('instagram.com')) return TruckInfo.socialMedia.instagram;
		else return String('https://www.instagram.com/' + TruckInfo.socialMedia.instagram + '/');
	};
	const getTwitterVal = () => {
		if (TruckInfo.socialMedia.twitter.includes('twitter.com')) return TruckInfo.socialMedia.twitter;
		else return String('https://twitter.com/' + TruckInfo.socialMedia.twitter + '/');
	};
	const Logout = async () => {
	...
	if (indicator) {
		return <ActivityIndicator size={'large'} color={'#000'} style={styles.indicator} />;
	} else {
		return (
			<Container>
				...
				<View style={[ styles.flexView, { marginTop: 0 } ]}>
					<Rating readonly startingValue={TruckInfo.rating} imageSize={responsiveFontSize(2.8)} />
					<View
						style={{
							flexDirection: 'row',
							width: '30%',
				...
				<TouchableOpacity onPress={() => Linking.openURL(TruckInfo.truckWebsite)} style={styles.iconView}>
					<Foundation
						style={{ marginLeft: responsiveWidth(1), width: '20%' }}
						name={'shield'}
						color={'#212121'}
				...
				<Modal showModal={visibleModal}>
					<View style={styles.crossView}>
						<TouchableOpacity onPress={() => setVisibleModal(false)}>
							<Entypo name={'circle-with-cross'} color={'#212121'} size={responsiveFontSize(3.5)} />
						</TouchableOpacity>
					</View>
                ...
                /> */}
								...
								<ListItem onPress={Logout} style={{ justifyContent: 'center', alignItems: 'center' }}>
									{/* <Entypo
                  name={'trash'}
                  color={'red'}
                  size={responsiveFontSize(2.5)}
