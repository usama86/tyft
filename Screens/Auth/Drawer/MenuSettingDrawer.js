		...
		return (
			<TouchableOpacity
				...
				style={{
					...
					borderBottomWidth: indexAfter && indexAfter !== item.category ? 0 : 0.3,
			...
			>
				<View style={styles.Left}>
					...
					<View style={{ flexDirection: 'row',width:'100%' }}>
						...
						<View style={{ marginTop: responsiveHeight(4),width:'60%',alignItems:'flex-end',flexDirection:'column' }}>
							<Entypo
								name={'pencil'}
								color={'black'}
		...
		<View style={{ height: '100%', width: '100%' }}>
				...
				<View>
					...
					>
						...
						>
							...
							/>
							<TouchableOpacity onPress={() => setShowModal(true)} style={{ left: responsiveWidth(7) }}>
								<AntDesign
									name={'pluscircle'}
									color={'rgb(193, 32, 38)'}
						...
						<Input
							...
							multiline={true}
							onChangeText={(e) => setDescription({ value: e, Error: false, ErrorText: null })}
						...
						/>
						{description.Error ? <ErrorView>{description.ErrorText}</ErrorView> : null}
						<Input
							rounded
							placeholder="Price"
							keyboardType={'number-pad'}
							onChangeText={(e) => setPrice({ value: e, Error: false, ErrorText: null })}
							value={price.value}
							style={styles.Input}
						/>
						...
						<View style={styles.TextView}>
							<Button style={styles.buttonStyle2} onPress={AddToList}>
								<Text uppercase={true} value={'Add to List'} style={{ color: 'white' }} />
							</Button>
						</View>
					</AddItemModal>
					<Modal showModal={showModal}>
						...
						>
							...
							<Button
								...
								rounded
							>
								<Text uppercase={false} value={'Add'} style={{ color: '#fff', fontWeight: 'bold' }} />
							</Button>
						</View>
					</Modal>
					{Data.length !== 0 ? (
			...
			<Modal showModal={showDeleteModal}>
				<View style={{ width: '90%', alignSelf: 'center' }}>
					...
					<Text style={{ top: responsiveHeight(2) }} value={'Are you sure you want to delete this item?'} />
					<View
						style={{
					...
					>
						<Button
							...
							rounded
						>
							<Text uppercase={false} value={'Yes'} style={{ color: '#fff', fontWeight: 'bold' }} />
						</Button>
						<Button
							onPress={() => setDeleteModal(false)}
							style={{
							...
							rounded
						>
							<Text uppercase={false} value={'No'} style={{ color: '#fff', fontWeight: 'bold' }} />
						</Button>
					</View>
				</View>
			</Modal>
